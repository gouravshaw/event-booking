...
# Update EC2_IP below with the IP from Terraform output after each new session.
set -e
...
export ECR_REGISTRY=910316760829.dkr.ecr.us-east-1.amazonaws.com
export AWS_REGION=us-east-1
export IMAGE_TAG=latest
export S3_BUCKET_NAME=event-booking-images-prod
export SQS_QUEUE_URL=https://sqs.us-east-1.amazonaws.com/910316760829/event-booking-ticket-updates
